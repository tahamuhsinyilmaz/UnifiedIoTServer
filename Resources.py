...
class JSONResource(Resource):
    ...
    def render_GET(self, request):
        self.payload = (
            defines.Content_types["application/json"], json.dumps({"e": [{"n": "temperature", "v": 23.5, "u": "degC"}]}))
...
class BasicResource(Resource):
    def __init__(self, name="BasicResource", coap_server=None):
        ...
        self.payload = "Taha Muhsin YILMAZ Test"
...
class Child(Resource):
    def __init__(self, name="ChildResource", coap_server=None):
        ...
        self.payload = "put ile mesaj alindi"

    def render_GET(self, request):
        return self

    def render_PUT(self, request):
        if request.payload == "thmyxlud":
            return self
